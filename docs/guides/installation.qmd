...
Required lists include: - **DCMI Type Vocabulary**: For resource types - **Internet Media Type**: For file formats - **ISO 639 Language Codes**: For languages
...
**Issue**:
 DSP API returns 403 Forbidden

**Solution**:
 - Verify user account has correct project permissions - Check if user account is active and not locked - Confirm API endpoints are correct
