...
::: panel-tabset
### 🚀 Setup with GitHub Codespaces (Most Users)
...
If you need to create the data model, use the provided `project.json`:
...
Note: The `project.json` file in the repository root contains the revised project definition with modernized metadata, expanded keywords, and updated ontology aligned with DaSCH and FAIR principles.
...
│   ├── data_model_dasch.json      # Legacy DSP data model (deprecated)
...
├── project.json                   # DSP project definition (revised)
